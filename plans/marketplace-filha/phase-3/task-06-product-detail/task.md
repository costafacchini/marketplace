...
- [ ] Cart store is persisted to localStorage (`marketplace-filha-cart` key)
- [ ] Changes committed to `plan/marketplace-filha/phase-3/task-06-product-detail` branch
